            ...
            <div className="transform transition-all duration-700 hover:translate-x-2">
              ...
              <div className="space-y-6">
                <p className="text-gray-600 leading-relaxed transform transition-all duration-500 hover:text-gray-800">
                  Le pub Vatola est bien plus qu'un simple lieu de rendez-vous à Antsirabe. C'est un lieu singulier dans la ville d'eau, un endroit qui incite au partage, à la fête, et à la détente. Ici, lesrencontres spontanées se mêlent aux conversations animées, tandis que le rire et la musique créent une atmosphère chaleureuse et accueillante.
                </p>
